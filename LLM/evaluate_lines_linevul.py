...
def main(args):
    ...
    def compute_metrics(ranks, preds):
        ...
        return {
            ...
            "IFA": torch.mean(ranks[ranks.isfinite()]),
            "TP-Top1-Acc": torch.sum(tp_ranks < 1) / len(tp_ranks),
    ...
    with open(f"LINEVUL___{args.dataset.replace('/', '__')}_successful.txt", "w") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="model/linevul/12heads_linevul_model.bin")
